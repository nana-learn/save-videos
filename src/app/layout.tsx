...
export const metadata: Metadata = {
  title: "Save Videos",
  description: "A simple page for displaying saved videos.",
};
        ...
        <nav className="border-b border-[#262626] bg-[#0a0a0a]/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14">
              ...
              <a
                href="https://github.com/nana-learn/save-videos"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-[#a3a3a3] hover:text-white transition-colors flex items-center gap-1.5"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
